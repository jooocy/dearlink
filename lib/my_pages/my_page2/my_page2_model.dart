...
import 'dart:ui';
import '/index.dart';
import 'my_page2_widget.dart' show MyPage2Widget;
...
class MyPage2Model extends FlutterFlowModel<MyPage2Widget> {
  ...
  // Stores action output result for [Backend Call - API (Get My Main Link)] action in MyPage2 widget.
  ...
  // Stores action output result for [Backend Call - API (Get Or Create link user)] action in MyPage2 widget.
  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        ...
        localStates: {
          'isReadOnly': debugSerializeParam(
            ...
            link:
                'https://app.flutterflow.io/project/dear-link-em0ufw?tab=uiBuilder&page=MyPage2',
            searchReference:
                'reference=QiQKEwoKaXNSZWFkT25seRIFMmZ6dTMqBxIFZmFsc2VyBAgFIAFQAVoKaXNSZWFkT25seWIHTXlQYWdlMg==',
            name: 'bool',
            nullable: false,
          ),
          'token': debugSerializeParam(
            ...
            link:
                'https://app.flutterflow.io/project/dear-link-em0ufw?tab=uiBuilder&page=MyPage2',
            searchReference:
                'reference=QhoKDgoFdG9rZW4SBXlvczE0KgISAHIECAMgAFABWgV0b2tlbmIHTXlQYWdlMg==',
            name: 'String',
            nullable: true,
          )
        },
        ...
        link:
            'https://app.flutterflow.io/project/dear-link-em0ufw/tab=uiBuilder&page=MyPage2',
        searchReference: 'reference=OgdNeVBhZ2UyUAFaB015UGFnZTI=',
        widgetClassName: 'MyPage2',
      );
}
