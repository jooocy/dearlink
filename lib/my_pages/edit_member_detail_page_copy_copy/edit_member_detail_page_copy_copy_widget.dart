...
import 'edit_member_detail_page_copy_copy_model.dart';
export 'edit_member_detail_page_copy_copy_model.dart';

class EditMemberDetailPageCopyCopyWidget extends StatefulWidget {
  const EditMemberDetailPageCopyCopyWidget({
    super.key,
  ...
  static String routeName = 'EditMemberDetailPageCopyCopy';
  static String routePath = '/te';

  @override
  State<EditMemberDetailPageCopyCopyWidget> createState() =>
      _EditMemberDetailPageCopyCopyWidgetState();
}

class _EditMemberDetailPageCopyCopyWidgetState
    extends State<EditMemberDetailPageCopyCopyWidget> with RouteAware {
  late EditMemberDetailPageCopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditMemberDetailPageCopyCopyModel());
  ...
  @override
  void didUpdateWidget(EditMemberDetailPageCopyCopyWidget oldWidget) {
