...
import 'm_edit_detail_page_model.dart';
export 'm_edit_detail_page_model.dart';

class MEditDetailPageWidget extends StatefulWidget {
  const MEditDetailPageWidget({
    super.key,
  ...
  static String routeName = 'M_EditDetailPage';
  static String routePath = '/editMemberDetailPage';

  @override
  State<MEditDetailPageWidget> createState() => _MEditDetailPageWidgetState();
}

class _MEditDetailPageWidgetState extends State<MEditDetailPageWidget>
    with RouteAware {
  late MEditDetailPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MEditDetailPageModel());
  ...
  @override
  void didUpdateWidget(MEditDetailPageWidget oldWidget) {
