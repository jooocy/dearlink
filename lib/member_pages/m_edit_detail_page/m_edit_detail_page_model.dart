...
import 'dart:ui';
import '/index.dart';
import 'm_edit_detail_page_widget.dart' show MEditDetailPageWidget;
...
class MEditDetailPageModel extends FlutterFlowModel<MEditDetailPageWidget> {
  ...
  // Stores action output result for [Backend Call - API (Get My Main Link)] action in M_EditDetailPage widget.
  ...
  // Stores action output result for [Backend Call - API (Get Or Create link user)] action in M_EditDetailPage widget.
  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        ...
        localStates: {
          'isReadOnly': debugSerializeParam(
            ...
            link:
                'https://app.flutterflow.io/project/dear-link-em0ufw?tab=uiBuilder&page=M_EditDetailPage',
            searchReference:
                'reference=QiQKEwoKaXNSZWFkT25seRIFMmZ6dTMqBxIFZmFsc2VyBAgFIAFQAVoKaXNSZWFkT25seWIQTV9FZGl0RGV0YWlsUGFnZQ==',
            name: 'bool',
            nullable: false,
          ),
          'token': debugSerializeParam(
            ...
            link:
                'https://app.flutterflow.io/project/dear-link-em0ufw?tab=uiBuilder&page=M_EditDetailPage',
            searchReference:
                'reference=QhoKDgoFdG9rZW4SBXlvczE0KgISAHIECAMgAFABWgV0b2tlbmIQTV9FZGl0RGV0YWlsUGFnZQ==',
            name: 'String',
            nullable: true,
          )
        },
        ...
        link:
            'https://app.flutterflow.io/project/dear-link-em0ufw/tab=uiBuilder&page=M_EditDetailPage',
        searchReference:
            'reference=OhBNX0VkaXREZXRhaWxQYWdlUAFaEE1fRWRpdERldGFpbFBhZ2U=',
        widgetClassName: 'M_EditDetailPage',
      );
}
