  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case PrismaMigrationsRow:
            return PrismaMigrationsRow(data);
          case LinkUsersRow:
            return LinkUsersRow(data);
          case LinkCategoriesRow:
            return LinkCategoriesRow(data);
          case UsersRow:
            return UsersRow(data);
          case LinksRow:
            return LinksRow(data);
          case InviteCodesRow:
            return InviteCodesRow(data);
          case CategoriesRow:
