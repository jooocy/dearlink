...
import 'q_answer_select_page_widget.dart' show QAnswerSelectPageWidget;
import 'package:flutter/material.dart';
import 'package:flutter/scheduler.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';

class QAnswerSelectPageModel extends FlutterFlowModel<QAnswerSelectPageWidget> {
  ...
  // Stores action output result for [Backend Call - API (Get Answers By Question)] action in Q_AnswerSelectPage widget.
  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        ...
        localStates: {
          'isReadOnly': debugSerializeParam(
            ...
            link:
                'https://app.flutterflow.io/project/dear-link-em0ufw?tab=uiBuilder&page=Q_AnswerSelectPage',
            searchReference:
                'reference=QiQKEwoKaXNSZWFkT25seRIFMmZ6dTMqBxIFZmFsc2VyBAgFIAFQAVoKaXNSZWFkT25seWISUV9BbnN3ZXJTZWxlY3RQYWdl',
            name: 'bool',
            nullable: false,
          ),
          'myAnswers': debugSerializeParam(
            ...
            link:
                'https://app.flutterflow.io/project/dear-link-em0ufw?tab=uiBuilder&page=Q_AnswerSelectPage',
            searchReference:
                'reference=QjMKEgoJbXlBbnN3ZXJzEgUzOG91enIdCBQqGRIXCg5BbnN3ZXJXSXRoVXNlchIFYmJsbWVQAVoJbXlBbnN3ZXJzYhJRX0Fuc3dlclNlbGVjdFBhZ2U=',
            name: 'AnswerWIthUser',
            nullable: true,
          )
        },
        ...
        link:
            'https://app.flutterflow.io/project/dear-link-em0ufw/tab=uiBuilder&page=Q_AnswerSelectPage',
        searchReference:
            'reference=OhJRX0Fuc3dlclNlbGVjdFBhZ2VQAVoSUV9BbnN3ZXJTZWxlY3RQYWdl',
        widgetClassName: 'Q_AnswerSelectPage',
      );
}
