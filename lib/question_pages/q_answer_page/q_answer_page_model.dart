...
class QAnswerPageModel extends FlutterFlowModel<QAnswerPageWidget> {
  ...
  // Stores action output result for [Backend Call - API (Get My Main Link)] action in Q_AnswerPage widget.
  ...
  // Stores action output result for [Backend Call - API (Get Or Create link user)] action in Q_AnswerPage widget.
